        ...
        >
          <div
            className={cn(
              ...
              hovered && "scale-125 shadow-xl ring-1 ring-gold/50",
            )}
            style={{
              width: "12px",
              height: "12px",
          ...
          {hovered && marker.label && (
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 px-2 py-0.5 bg-black/80 text-white text-[6px] whitespace-nowrap rounded">
              {marker.label}
            </div>
          )}
        </Html>
